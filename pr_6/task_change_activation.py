...
if __name__ == '__main__':
    ...
    network.add(layers.Dense(units=512, activation='tanh', input_shape=(28 * 28,)))
    ...
    train_images_reshaped = reshape_images(images=train_images, image_choice="Training", num_images=len(train_images))
    test_images_reshaped = reshape_images(images=test_images, image_choice="Test", num_images=len(test_images))
