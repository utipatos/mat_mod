...
def reshape_images(images: ndarray,
    ...
    reshaped_images = images.reshape((len(images), img_shape[0], img_shape[1], 1))
...
if __name__ == '__main__':
    ...
    train_images_reshaped = reshape_images(images=train_images, image_choice="Training", img_shape=(28, 28, 1))
    test_images_reshaped = reshape_images(images=test_images, image_choice="Test", img_shape=(28, 28, 1))
